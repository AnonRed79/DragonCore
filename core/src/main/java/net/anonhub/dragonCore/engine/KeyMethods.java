...
//        move up
    static {
        keyDownMethods.add((int keyCode) -> {
            for (short settingKeyCode: config.getShortMulti("actions/moveUp")) {
...
//        move down
        keyDownMethods.add((int keyCode) -> {
            for (short settingKeyCode: config.getShortMulti("actions/moveDown")) {
                if (keyCode == settingKeyCode && !subMode.menu) {
                    for (Entity entity:Entity.entities) {
                        if (entity.data.player) {
...
//        move left
        keyDownMethods.add((int keyCode) -> {
            for (short settingKeyCode: config.getShortMulti("actions/moveLeft")) {
                if (keyCode == settingKeyCode && !subMode.menu) {
                    for (Entity entity : Entity.entities) {
                        if (entity.data.player) {
...
//        move right
        keyDownMethods.add((int keyCode) -> {
            for (short settingKeyCode: config.getShortMulti("actions/moveRight")) {
                if (keyCode == settingKeyCode && !subMode.menu) {
                    for (Entity entity:Entity.entities) {
                        if (entity.data.player) {
        ...
        keyDownMethods.add((int keyCode) -> {
            for (short settingKeyCode: config.getShortMulti("actions/sprint")) {
                if (keyCode == settingKeyCode && !subMode.menu) {
                    for (Entity entity:Entity.entities) {
                        if (entity.data.player) {
...
//        open terminal
        keyUpMethods.add((int keyCode) -> {
            for (short settingKeyCode: config.getShortMulti("actions/openTerminal")) {
                if (keyCode == settingKeyCode && !subMode.menu) {
...
//        quit game
        keyUpMethods.add((int keyCode) -> {
            for (short settingKeyCode: config.getShortMulti("actions/quit")) {
                if (keyCode == settingKeyCode && !subMode.menu) {
                    Gdx.app.exit();
                }
            }
...
//        close
        keyUpMethods.add((int keyCode) -> {
            for (short settingKeyCode: config.getShortMulti("actions/exit")) {
