package net.anonhub.dragonCore.lwjgl3;

import com.badlogic.gdx.backends.lwjgl3.Lwjgl3Application;
import com.badlogic.gdx.backends.lwjgl3.Lwjgl3ApplicationConfiguration;
import net.anonhub.dragonCore.engine.Main;

/** Launches the desktop (LWJGL3) application. */
public class Lwjgl3Launcher {
    public static void main(String[] args) {
//    System.setProperty("org.lwjgl.glfw.platform", "x11");
//    System.setProperty("org.lwjgl.system.egl", "false");
    ...
    private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        ...
        configuration.setTitle("DragonCore");
